 ...
 * @Omar Gómez
 */
public class POOP2_Ant {
    public static void main(String[] args) {
        /**
         * imprime "hola mundo" dos veces
         */
        System.out.println("Hola mundo");
        System.err.println("Hola mundo");
        /**
         * sistema condicional if
         */
        ...
        int b = 10;
        /**
         * si a es menor a b escribirlo
         */
        if (a<b) {
            System.out.println("a es menor que b");
        } 
        /**
         * ademas si a=b escribirlo
         */
        else if (a==b){
            System.out.println("a es igual a b");
        }
        /**
         * si no escribir a es mayor que ve
         */
        else{
        ...
        System.out.println("############## if ##############");
        /** 
         * menor(x,y)=menor(a,b) escribir "metodo menor retorna true"
         */
        if(menor(a,b)){
            System.out.println("metodo menor retorna true");
        }
        /**
         * si menor(x,y)diferente a menor(a,b) escribir "metodo menor retorna false"
         */
        else{
            System.out.println("metodo menor retorna false");
        }
        /**
         * el condicional ESCOGER
         */
        System.out.println("############## Switch ##############");
        /**
         * inicializa dia entero=1
         */
        int dia = 1;
        /**
         * Para el dia
        ...
        switch (dia) {
            /**
             * Caso dia =dia de la semana
             * si dia es diferente de 7 "diaincorrecto"
             */
            case 1: 
        ...
        /**
         * Condicianate ESCOGER
         */
        System.out.println("############## Switch ##############");
        char vocal = '9';
        /**
         * inicializa vocal=9 y para casos de la a - u, "selecciono vocal x"
         * default "No selecciono vocal"
         */
        switch (vocal) {
         ...
         * iterativo MIENTRAS
         * inicializa n=0
         * mientras n menor a 10 escribir "Contando hacia arriba"
         * sumar 1 a n
         * mientars n mayor a 0 escribir "contando hacia abajo"
         * restar 1 a n
         * imprimir "n"
         */
        ...
        /**
         * Iterador HACER MIENTRAS
         * Imprimir "contando hacia abajo"
         * n-1 
         * minetras n se menor a 0
         * imprimir "n="
         */
         ...
         * Condicionate PARA
         * inizilaiza i=0
         * para i menor a 10 i=i+1
         * imprimir "contando hacia arriba"
         * para i=10  mayor a 0, i=i-1
         * imprimir "contando hacia abajo"
         */
